...
export class BookingMaster extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    axios
      .get("http://localhost:8085/bookings")
      .then((response) => {
        debugger;
      ...
      <div className="section-bg">
          ...
          <div className="container d-flex align-items-center">
            ...
            <nav id="navbar" className="navbar order-last order-lg-0">
              <ul>
                ...
                <li>
                  <a className="nav-link active" href="/BookingMaster">
                    Bookings
                  </a>
                </li>
              </ul>
        ...
        <section id="main" className="d-flex align-items-center topMargin">
          <div className="container">
            <div>
              <h4 align="center">Booking Master</h4>
