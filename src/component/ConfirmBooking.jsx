...
export class ConfirmBooking extends Component {
  ...
  componentDidMount() {
    axios
      .get("http://localhost:8085/GetBookingById/" + this.state.Id)
      .then((response) => {
        debugger;
          ...
          <div className="container">
            <div>
              ...
              <table className="table table-striped" style={{ marginTop: 10 }}>
                ...
                <tbody>
                  <tr key={this.state.booking.bookingId}>
                    <td>{this.state.booking.eventName}</td>
                    <td>{this.state.booking.guideName}</td>
                    ...
                    <td>{this.state.booking.childs}</td>
                    <td>{this.state.booking.totalPrice}</td>
